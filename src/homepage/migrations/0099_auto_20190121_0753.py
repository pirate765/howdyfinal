# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-01-21 07:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('homepage', '0098_auto_20190121_0743'),
    ]

    operations = [
        migrations.CreateModel(
            name='UpcomingtripVideo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('link', models.URLField()),
                ('upcomingtrip', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='uptripvideos', to='homepage.UpcomingTrip')),
            ],
        ),
        ...
        migrations.AlterField(
            model_name='video',
            name='destination',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='destvideos', to='homepage.Destinationpackage'),
        ),
    ]
