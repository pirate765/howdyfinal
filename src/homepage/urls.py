...
urlpatterns = [
    ...
    url(r'^destinationgroupbook/(?P<id>[0-9]+)/$', views.destinationgroupbook, name='destinationgroupbook'),
    ...
    url(r'^aboutus/$', views.travelfree, name='aboutus'),
    url(r'^destination/$', views.destination, name='destination'),
    url(r'^traveldiaries/$', views.traveldiaries, name='traveldiaries'),
    url(r'^articletaglist/(?P<pk>[0-9]+)/$', views.articletaglist, name='articletaglist'),
